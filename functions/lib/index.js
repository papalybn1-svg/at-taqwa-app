...
exports.cleanupExpiredResetLinks = exports.sendPasswordResetEmail = void 0;
...
exports.cleanupExpiredResetLinks = functions.pubsub.schedule('every 24 hours').onRun(async (context) => {
    try {
